...
import { SpeedlifyStatsLight } from '../utils/SpeedlifyStatsLight';
...
function Button({ children, size, variant, className, ...props }: {
    ...
    const variantStyles = variant === 'outline' ? 'border-gray-300 bg-transparent text-gray-700 hover:bg-gray-100' : '';
                    ...
                    <div className="white-footer-grid-texture relative flex h-full w-full flex-col justify-center items-center gap-5 text-gray-900" style={{ 
                        ...
                        >
                            <div className="absolute top-0 left-0 h-80 w-40 rounded-full opacity-10" style={{
                                background: 'radial-gradient(circle, rgba(69,35,174,0.1) 0%, rgba(69,35,174,0.02) 50%, transparent 100%)',
                                transform: 'translateY(-5rem) rotate(-45deg)'
                            }} />
                            <div className="absolute top-0 left-0 h-80 w-60 rounded-full opacity-10" style={{
                                background: 'radial-gradient(circle, rgba(69,35,174,0.08) 0%, rgba(69,35,174,0.01) 80%, transparent 100%)',
                        ...
                        <AnimatePresence mode="wait">
                            {showSpaceInvaders ? (
                                <motion.div
                                    ...
                                    className="white-footer-content-container w-full max-w-[1200px] mx-auto flex flex-col justify-center items-center py-8 relative z-20 overflow-x-hidden"
                                >
                                ...
                                <motion.div
                                    ...
                                    exit={{ opacity: 0, scale: 0.8 }}
                                    transition={{ duration: 0.5 }}
                                    className="white-footer-content-container w-full max-w-[1200px] mx-auto flex flex-col justify-between gap-5 py-8 relative z-20"
                                >
                                ...
                                <AnimatedContainer className="w-full">
                                    ...
                                    >
                                        <div className="w-full flex flex-col justify-start items-start gap-3">
                                            ...
                                            <p className="w-full max-w-lg text-gray-700 font-primary text-lg font-medium leading-relaxed">
                                                {t.followDescription}
                                            </p>
                                        </div>
                            ...
                            <AnimatedContainer delay={0.4} className="w-full">
                                <div className="w-full flex flex-col gap-4 py-16 border-t border-gray-200" style={{ paddingTop: '1rem' }}>
...
// Añadir estilos globales para el texto gigante y textura de grid - Versión White
if (typeof document !== 'undefined') {
    const style = document.createElement('style');
    style.textContent = `
        .white-karen-ortiz-container {
            text-align: center;
        ...
        .white-karen-ortiz-flip-text .flip-text-container {
            font-family: var(--font-display) !important;
        ...
        .white-footer-grid-texture::before {
            content: '';
            position: absolute;
            top: 0;
            left: 0;
        ...
        @media (max-width: 1200px) {
            .white-footer-content-container {
