...
const ArcGalleryHeroComponent: React.FC<ArcGalleryHeroProps> = ({
  images,
  startAngle = 20,
  endAngle = 160,
  radiusLg = 480,
            ...
            return (
              ...
              >
                <div 
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.transform = `rotate(${angle / 4}deg) scale(1.05)`;
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.transform = `rotate(${angle / 4}deg) scale(1)`;
                  }}
                >
                  {/* Tape decoration with variations */}
                  <div
                    style={{
                      position: 'absolute',
                      top: i % 2 === 0 ? '-12px' : '-8px',
...
export const ArcGalleryHero = React.memo(ArcGalleryHeroComponent);
